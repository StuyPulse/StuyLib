 ...
 */
public class PIDBangBangCalculator extends Controller {
     ...
     */
    public PIDBangBangCalculator(double speed) {
        mControlSpeed = speed;
     ...
     */
    public PIDBangBangCalculator setControlSpeed(double speed) {
        mControlSpeed = speed;
        return this;
    }
     ...
     */
    public PIDBangBangCalculator setTunerType(PIDTunerType tuner) {
        this.mTuner = tuner;
        return this;
    }

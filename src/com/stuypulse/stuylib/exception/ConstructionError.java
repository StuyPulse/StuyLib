...
public class ConstructionError extends RuntimeException {
    ...
    /**
     * Create exception with formatted error message if construction is
     * incorrectly given constructor name and the error to be thrown
     *
     * @param constructor constructor name formatted like "ClassName(Type
     *                    Variable)"

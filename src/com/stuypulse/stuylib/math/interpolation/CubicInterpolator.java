 ...
 *
 * <p>The polynomial can be written as P(t) = h00(t)p0 + h10(t)m0 + h01(t)p1 + h11(t)m1
 *
 * <p>in which P(t) is the polynomial p0 and p1 are the y coordinates of the reference points h00(t)
 ...
 *
 * <p>It can be thought of as interpolating between the derivatives.
 ...
 *
 * <p>more information can be found here: https://en.wikipedia.org/wiki/Cubic_Hermite_spline
 *
